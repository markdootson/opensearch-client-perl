...
$OpenSearch::Client::Core::3_0::Direct::SnapshotManagement::VERSION = '3.007004';
use Moo;
with 'OpenSearch::Client::Core::3_0::Role::API';
with 'OpenSearch::Client::Role::Client::Direct';
use namespace::clean;

__PACKAGE__->_install_api('sm');
...
B<OpenSearch::Client::Core::3_0::Direct::SnapshotManagement>
...
B<Snapshot Management API>


Use the Snapshot Management (SM) API to automate taking snapshots.

L<See OpenSearch documentation for sm.|https://docs.opensearch.org/latest/tuning-your-cluster/availability-and-recovery/snapshots/sm-api/>
...
=item
C<POST /_plugins/_sm/policies/{policy_name}>
...
=item
C<DELETE /_plugins/_sm/policies/{policy_name}>
...
=item
C<GET /_plugins/_sm/policies/{policy_name}/_explain>
...
=item
C<GET /_plugins/_sm/policies/{policy_name}>
...
=item
C<POST /_plugins/_sm/policies/{policy_name}/_stop>
...
=item
C<PUT /_plugins/_sm/policies/{policy_name}>
