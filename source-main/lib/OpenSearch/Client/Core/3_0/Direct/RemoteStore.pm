...
$OpenSearch::Client::Core::3_0::Direct::RemoteStore::VERSION = '3.007004';
use Moo;
...
L<OpenSearch documentation for remote_store.restore|https://opensearch.org/docs/latest/opensearch/remote/#restoring-from-a-backup>
