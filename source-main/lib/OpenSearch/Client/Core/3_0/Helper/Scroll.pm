...
$OpenSearch::Client::Core::3_0::Helper::Scroll::VERSION = '3.007004';
use Moo;
...
with 'OpenSearch::Client::Role::Is_Sync',
    'OpenSearch::Client::Core::3_0::Role::Helper::Scroll';
...
OpenSearch::Client::Core::3_0::Helper::Scroll - A helper module for scrolled searches
...
Perhaps you want to move a subset of the data in one index into
