...
$OpenSearch::Client::Cxn::LWP::VERSION = '3.007003';
use Moo;
...
L<OpenSearch::Client::Cxn::LWP> uses L<IO::Socket::SSL> to support
HTTPS.  By default, full verification of the remote host certificate
is performed.

If the remote server cannot be verified, an
L<OpenSearch::Client::Error|Cxn error> will be thrown - LWP does not
...
with any options passed through to L<IO::Socket::SSL> by L<LWP::UserAgent>
...
=item * L<OpenSearch::Client::Cxn::HTTPTiny>
